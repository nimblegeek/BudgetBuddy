...
# Navigation tabs
tab1, tab2 = st.tabs(["📊 Dashboard", "💳 Manage Expenses & Budget"])
    ...
    with col2:
        ...
        for cat in categories:
            ...
            actual_values.append(
                float(monthly_expenses[monthly_expenses['category'] == cat]['amount'].sum()))
...
with tab2:
    # Create two columns for expense and budget forms
    exp_col, bud_col = st.columns(2)
